...
Ttable.column("one", width=150)
Ttable.column("two", width=150)
Ttable.column("three", width=80)
Ttable.heading("one", text="Ученик")
Ttable.heading("two", text="Класс")
Ttable.heading("three", text="Оценка")
