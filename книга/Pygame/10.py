...
def collideG(Sprite, Group):
    ...
    for Spr in Group.sprites():
        if collide(Sprite.collider, Spr.collider):
            Iscollide = True
            s = Spr.rect
    return Iscollide
...
Ground1 = Platform(80, 400, 'Images/ground.png', 100, GroupPlatform)
Ground2 = Platform(380, 300, 'Images/ground.png', 100, GroupPlatform)
